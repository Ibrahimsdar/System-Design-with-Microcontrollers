...
char uart_tx_buf[40];      //holds string to send to crt char uart_rx_buf[40];
//holds string that recieves data from uart
...
//****************************************************************** uart_puts
//Takes a string and sends each charater to be sent to USART0 void
//uart_puts(unsigned char *str) {
void uart_puts(char *str) { int i = 0;               
